...
import com.example.unionpay.sdk.Acp6Service;
import com.example.unionpay.sdk.SDKConstants;
...
public class GmAcp6Service {
	...
	public static Map<String, String> signByCertInfo(Map<String, String> reqData, String certPath, 
        ...
        Map<String, String> data = com.example.unionpay.sdk.SDKUtil.filterBlank(reqData);

        if (com.example.unionpay.sdk.SDKUtil.isEmpty(encoding)) {
            encoding = "UTF-8";
        }
        
        if (com.example.unionpay.sdk.SDKUtil.isEmpty(certPath) || com.example.unionpay.sdk.SDKUtil.isEmpty(certPwd)) {
            return data;
        }
	...
	public static String encryptPin(String accNo, String pin, String encoding) {
		byte[] pinblock = com.example.unionpay.sdk.SecureUtil.pinblock(accNo, pin); //pinblock算法确认过和国际一致
